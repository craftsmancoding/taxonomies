...
class BaseController extends \modExtraManagerController {
   ...
   // public $scriptProperties = array();
    ...
    public function __call($name,$args) {
        $this->modx->log(\modX::LOG_LEVEL_ERROR,'[taxonomies] Invalid function name '.$name);
    ...
    public function fetchTemplate($file) {
        ...
        $path = $this->modx->getOption('taxonomies.core_path','', MODX_CORE_PATH.'components/taxonomies/').'views/';
    ...
    public function getLanguageTopics() {
        return array('taxonomies:default');
    }
    ...
    public function setMsg($msg,$type='success') {
        ...
        $path = $this->modx->getOption('taxonomies.core_path','', MODX_CORE_PATH.'components/taxonomies/').'views/msgs/';
        $file = $path.$type.'.php';
        if (is_file($file)) {
            ob_start();
            include $file;
