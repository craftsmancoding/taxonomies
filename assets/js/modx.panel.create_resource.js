...
//            ,items: grid // [] // this.getMainFields(config) // <-- form fields for this tab
        ...
        it.push({
            ...
            ,items: this.getMainFields(config) // <-- form fields for this tab
        });
        ...
        its.push(this.getPageHeader(config),{
            ...
            ,animCollapse: false
            ,itemId: 'tabs'
            ,items: it // <-- items go here
        });
        var ct = this.getContentField(config);
        if (ct) {
            its.push({
                title: _('resource_content') // Main content block
        ...
        return [{
            ...
            ,listeners: {
                'keyup': {scope:this,fn:function(f,e) {
                    var titlePrefix = MODx.request.a == MODx.action['resource/create'] ? _('new_store') : _('store');
